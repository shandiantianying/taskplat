<template>
  <div class="index-vue">
    ...
    <aside :class="asideClassName">
      <!-- logo -->
      <div class="logo-c">
        <img src="../assets/imgs/timg.jpg" alt="logo" class="logo" />
    ...
    >
      <Form ref="formCustom" :model="formCustom" :label-width="80">
            <FormItem label="用户名" prop="username" disabled  >
...
export default {
  ...
  watch: {
    $route(to) {
      ...
      console.log(this.keepAliveData);
  ...
  methods: {
    ok() {
      this.editFlag = true;
      if (this.formCustom.passwd == this.pwd) {
        this.$Message.error("原密码与新密码一致，不需要输入！");
      } else {
        let params = {
