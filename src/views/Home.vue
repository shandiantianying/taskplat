    ...
    drawPie2() {
      ...
      request({
        ...
        .then(res => {
          ...
          this.pieCharts = echarts.init(document.getElementById("pie2")); // 初始化图表实例
  ...
  drawPie3() {
      ...
      request({
        ...
        .then(res => {
          ...
          this.pieCharts = echarts.init(document.getElementById("pie3")); // 初始化图表实例
          this.pieCharts.setOption(options); // 设置图表配置项
        })
        .catch(res => {
          this.isShowLoading = false;
  ...
  drawPie4() {
      ...
      request({
        ...
        .then(res => {
          ...
          this.pieCharts = echarts.init(document.getElementById("pie4")); // 初始化图表实例
          this.pieCharts.setOption(options); // 设置图表配置项
        })
        .catch(res => {
          this.isShowLoading = false;
  ...
  drawPie5() {
      ...
      request({
        ...
        .then(res => {
          ...
          this.pieCharts = echarts.init(document.getElementById("pie5")); // 初始化图表实例
          this.pieCharts.setOption(options); // 设置图表配置项
        })
        .catch(res => {
          this.isShowLoading = false;
  ...
  drawPie6() {
      ...
      request({
        ...
        .then(res => {
          ...
          this.pieCharts = echarts.init(document.getElementById("pie6")); // 初始化图表实例
          this.pieCharts.setOption(options); // 设置图表配置项
        })
        .catch(res => {
          this.isShowLoading = false;
